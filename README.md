...
🌐 **Live:** https://soid-prototype-pavelbendin-3656s-projects.vercel.app
📦 **Repo:** https://github.com/dsgnasd/soid-prototype

Демо-прототип веб-интерфейса **Системы обработки инженерных данных (СОИД)**. Реализует ИА и сценарии из артефактов UX-фазы, работает на моках (без реального бэкенда) через MSW.
